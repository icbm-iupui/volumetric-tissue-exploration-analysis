...
public class LayerCake3DLargeScaleSingleThreshold extends AbstractSegmentation {
...
//            System.out.println("PROFILING: y start position: " + y );
    ...
    private class SegmentationForkPool extends RecursiveAction {
