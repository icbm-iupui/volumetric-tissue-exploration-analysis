 ...
 * @author sethwinfree
 */
public class PlotOutputFrame extends javax.swing.JFrame implements UpdatePlotSettingsListener {
    ...
    public void process(String key, String title, ArrayList descriptions, ArrayList descriptionLabel) {
        ...
        plotFeature.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String value = (String) plotFeature.getSelectedItem();
    ...
    private void initComponents() {
        ...
        SavePlot.setToolTipText("Delete current plot...");
    ...
    private void ForwardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ForwardActionPerformed
        ...
        setPlot();
        //this.Status.setText("Total graphs: " + go.getPlotCount() + ", on graph " + position);
        // Status.validate();
        // Status.repaint();
    ...
    private void GenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GenerateActionPerformed
        ...
        new Thread(() -> {
            try {
                ...
                settings.add((String) this.plotFeature.getSelectedItem());
                settings.add((String) this.groupType.getSelectedItem());

                PlotProcessor pp = new PlotProcessor(key, settings);
                pp.run();
    ...
    private void SavePlotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SavePlotActionPerformed
        ...
        do {
            ...
            jf.setDialogTitle("Save VTEA plot...");
