...
public class KNNLouvain extends AbstractFeatureProcessing {
    ...
    public KNNLouvain() {
        VERSION = "0.1";
        AUTHOR = "Seth WInfree";
        COMMENT = "Implements KNN graph generation and louvain "
                + "community detection ";
        NAME = "KNN Louvain";
        KEY = "KNNlouvain";
        TYPE = "Cluster";
    ...
    public boolean process(ArrayList al, double[][] feature, boolean val) {
        ...
        //partition useing the louvain approach
        ...
        KNN knn = new KNN(tree, labels, 3);
        
        knn = KNN.learn(key, labels, k);
