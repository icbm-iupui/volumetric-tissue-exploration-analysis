...
/**
 * Hierarchical Clustering using Single-Link. After merging two clusters the new
 * cluster is given a dissimilarity value based on the minimum distance between
 * elements of this cluster with another cluster.
 *
 * @author drewmcnutt
 */
...
public class SingleCluster extends AbstractHierarchical {
    ...
    /**
     * Using Single-Link Hierarchical Clustering calculates the hierarchical
     * tree.
     *
