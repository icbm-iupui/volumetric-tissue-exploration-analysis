...
/**
 * Hierarchical Clustering using Ward. After merging two clusters the new
 * cluster is given a dissimilarity value based on the error sum of squares
...
public class WardCluster extends AbstractHierarchical {
    ...
    /**
     * Calculates the proximity matrix of the features and using Ward
     * Hierarchical Clustering returns true when complete
     *
