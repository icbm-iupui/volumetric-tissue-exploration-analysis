 ...
 * @author vinfrais
 */
public class ProcessStepBlockGUI extends Object implements Serializable, Cloneable, MicroBlockSetupListener {
    ...
    ;
        ...
        mbs = new vteaprotocol.setup.MicroBlockProcessSetup(position, Channels, protocol, OriginalImage);
