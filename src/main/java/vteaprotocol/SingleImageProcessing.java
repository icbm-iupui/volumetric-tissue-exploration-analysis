...
import vteaprotocol.menus.MultipleFilesMenu;
import vteaprotocol.listeners.AnalysisStartListener;
...
import vteaprotocol.listeners.RepaintTabListener;
import vteaprotocol.listeners.RequestImageListener;
import vteaprotocol.listeners.TransferProtocolStepsListener;
import vteaprotocol.setup.MicroBlockObjectSetup;
import vteaprotocol.blockstepgui.ProcessStepBlockGUI;
import vteaprotocol.listeners.FileOperationListener;
import vteaprotocol.listeners.UpdateProgressListener;
import vteaprotocol.listeners.UpdateSegmentationListener;
import vteaprotocol.listeners.UpdatedProtocolListener;
...
//batch support
    ...
    private void initComponents() {
        ...
        OpenImage.setBackground(vtea.VTEA.BUTTONBACKGROUND);
        ...
        DeleteAllSteps_PreProcessing.setBackground(vtea.VTEA.BUTTONBACKGROUND);
        ...
        PreProcessingStepsPanel.setBackground(vtea.VTEA.ACTIONPANELBACKGROUND);
        ...
        PreProcessingGo.setBackground(vtea.VTEA.BUTTONBACKGROUND);
        ...
        ObjectStepsPanel.setBackground(vtea.VTEA.ACTIONPANELBACKGROUND);
        ...
        ObjectGo.setBackground(vtea.VTEA.BUTTONBACKGROUND);
    ...
    private void PreProcessingGoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PreProcessingGoActionPerformed
      ...
      public void run() {
        ...
        this.FindObjectText.setForeground(vtea.VTEA.ACTIVETEXT);
...
//classes for step blocks
    private final class ObjectStepBlockGUI extends Object implements MicroBlockSetupListener, UpdatedImageListener, UpdatedProtocolListener {
        ...
        private void BuildStepBlock(String ProcessText, String CommentText, Color BlockColor) {
            ...
            UpdateExplorer.setBackground(vtea.VTEA.BUTTONBACKGROUND);
...
//            step.add(UpdateExplorer, layoutConstraints);
    ...
    private void notifyUpdateSegmentationListeners(int tab) {
        ...
        public void onChangeSetup(ArrayList al2) {
            ...
            Object.setText("Object_" +getPosition()+ ": " + vtea.VTEA.PROCESSOPTIONS[(Integer) al.get(1)] + ", by: " + Channels.get((Integer) al.get(0)).toString());
    ...
    public ArrayList getProcessSteps() {
        ...
        //for (ProcessStepBlockGUI block : ProcessingStepsList) {
            try {
                ...
                ((MicroBlockProcessSetup)psbg.getSetup()).updatePreviewImage(OriginalImage);
                export.add(psbg);
...
//            frame.setBackground(VTC.VTEAService.BUTTONBACKGROUND);
